...
struct HNSW {
    ...
    HNSWStats search(
            ...
            const std::string& csv_filename = "/mnt/nfs/home/ppesaladinne/work1/hnsw_metrics.csv",
            const std::string& recall_filename = "/mnt/nfs/home/ppesaladinne/work1/hnsw_results.csv") const;
